...
namespace ChessGameTests
{
    public class DefferedCheck
    {
        ...
        public void FigureDeffersCheck_True(IFigure opponent, IFigure inTheMiddle, IFigure king)
        {
            ...
            var calculatedOptions = new BoardProcessor(new Board(figures)).CalculateInitBoard(king.Color).GetFigure(opponent.Coordinate).AttackOptions;
            Assert.Contains(o, calculatedOptions);
        }
    }
}
