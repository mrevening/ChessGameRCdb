...
//            var action = game.PlayersAction(Player.White, new Coordinate(Column.D, Row.Two), new Coordinate(Column.D, Row.Four));
...
//            var action = game.PlayersAction(Player.White, new Coordinate(Column.D, Row.Three), new Coordinate(Column.D, Row.Five));
...
//            var action = game.PlayersAction(Player.White, new Coordinate(Column.D, Row.Four), new Coordinate(Column.D, Row.Five));
//            Assert.Throws<BlockedMoveException>(() => action);
//        }
//        [Fact]
