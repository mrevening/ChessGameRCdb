...
namespace ChessGame.Logic
{
    public class Pawn : Figure
    {
        ...
        public override List<IActiveAction> MoveTypes { get => new List<IActiveAction>() { new OneTileForwardMove(), new TwoTilesForwardMove(), new OneTileDiagonalCapture(), new EnPassant(), new Promotion() }; }
